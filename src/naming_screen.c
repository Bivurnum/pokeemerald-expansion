...
{
    DoNamingScreen(NAMING_SCREEN_PLAYER, gSaveBlock2Ptr->playerName, gSaveBlock2Ptr->friendChoice, 0, 0, CB2_ReturnToFieldWithOpenMenu);
}

static void UNUSED Debug_NamingScreenBox(void)
{
    DoNamingScreen(NAMING_SCREEN_BOX, gSaveBlock2Ptr->playerName, gSaveBlock2Ptr->friendChoice, 0, 0, CB2_ReturnToFieldWithOpenMenu);
}

static void UNUSED Debug_NamingScreenCaughtMon(void)
{
    DoNamingScreen(NAMING_SCREEN_CAUGHT_MON, gSaveBlock2Ptr->playerName, gSaveBlock2Ptr->friendChoice, 0, 0, CB2_ReturnToFieldWithOpenMenu);
}

static void UNUSED Debug_NamingScreenNickname(void)
{
    DoNamingScreen(NAMING_SCREEN_NICKNAME, gSaveBlock2Ptr->playerName, gSaveBlock2Ptr->friendChoice, 0, 0, CB2_ReturnToFieldWithOpenMenu);
}
