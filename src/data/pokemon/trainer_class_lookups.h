const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_FRIEND_KYLE] = TRAINER_PIC_FRIEND_KYLE,
    [FACILITY_CLASS_FRIEND_BREN] = TRAINER_PIC_FRIEND_BREN,
    [FACILITY_CLASS_FRIEND_SPENCER] = TRAINER_PIC_FRIEND_SPENCER,
