...
const u16 gMetatiles_TreasureIsland[] = INCBIN_U16("data/tilesets/primary/treasure_island/metatiles.bin");
const u16 gMetatileAttributes_TreasureIsland[] = INCBIN_U16("data/tilesets/primary/treasure_island/metatile_attributes.bin");
