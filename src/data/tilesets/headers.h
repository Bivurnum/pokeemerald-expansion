...
const struct Tileset gTileset_SpaExterior =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_SpaExterior,
    .palettes = gTilesetPalettes_SpaExterior,
    .metatiles = gMetatiles_SpaExterior,
    .metatileAttributes = gMetatileAttributes_SpaExterior,
    .callback = NULL,
};
