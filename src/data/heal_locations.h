static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_KYLES_HOUSE_2F - 1] = {MAP_GROUP(LITTLEROOT_TOWN_KYLES_HOUSE_2F), MAP_NUM(LITTLEROOT_TOWN_KYLES_HOUSE_2F), 4, 2},
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_KYLES_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 17, 16},
