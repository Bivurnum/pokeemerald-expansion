...
static bool32 LoadMapInStepsLocal(u8 *state, bool32 a2)
{
    ...
    case 10:
        ...
        break;
    case 11:
        if (MPS_ENABLE_MAP_PREVIEWS && CanDoMapPreviewForest() && GetLastUsedWarpMapSectionId() != gMapHeader.regionMapSectionId && MapHasPreviewScreen_HandleQLState2(gMapHeader.regionMapSectionId, MPS_TYPE_FOREST) == TRUE)
        {
