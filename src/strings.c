...
const u8 gText_MatchCallBrendan_Intro1[] = _("I'll be the best POKéMON");
const u8 gText_MatchCallBrendan_Intro2[] = _("TRAINER there ever was!");
const u8 gText_MatchCallMay_Strategy[] = _("I really go for it!");
const u8 gText_MatchCallMay_Pokemon[] = _("I'll use any POKéMON!");
const u8 gText_MatchCallMay_Intro1[] = _("My POKéMON go all out and");
const u8 gText_MatchCallMay_Intro2[] = _("help me win with style!");
const u8 gText_MatchCallKyle_Strategy[] = _("Patience is key.");
const u8 gText_MatchCallKyle_Pokemon[] = _("A balanced team is best.");
const u8 gText_MatchCallKyle_Intro1[] = _("The fire of adventure");
const u8 gText_MatchCallKyle_Intro2[] = _("keeps me going!");
