...
const u8 gText_SpaInstructions[] = _("{A_BUTTON} : Interact    hold{B_BUTTON} : Fast    hold{SELECT_BUTTON} : Status");
const u8 gText_SpaItemSelectInstructions[] = _("{DPAD_UPDOWN} : Move            {A_BUTTON} : Select            {B_BUTTON} : Exit");
const u8 gText_SpaItemInstructions[] = _("{A_BUTTON} : Put Away    hold{B_BUTTON} : Fast    hold{SELECT_BUTTON} : Status");
