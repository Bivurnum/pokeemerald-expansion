...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/new_title_screen.4bpp.smol");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/new_title_screen.bin.smolTM");
